...
export class ScreenTimeApi {
    static checkModule() {
        if (!ReactNativeScreenTimeModule) {
            throw new Error('ReactNativeScreenTime module is not available. ' +
        ...
        if (typeof ReactNativeScreenTimeModule.requestAuthorization !== 'function') {
            throw new Error('ReactNativeScreenTime module methods are not available. ' +
     ...
     */
    static async getScreenTimeReport(startDate, endDate) {
     ...
     */
    static async getTodayScreenTime() {
     ...
     */
    static async setAppTimeLimit(bundleId, timeLimit) {
     ...
     * @returns Promise<string> - Success message
     */
    static async removeAppTimeLimit(bundleId) {
     ...
     * @returns Promise<string> - Success message
     */
    static async blockApplication(bundleId) {
     ...
     * @returns Promise<string> - Success message
     */
    static async unblockApplication(bundleId) {
     ...
     */
    static async getInstalledApplications() {
     ...
     */
    static async getWeeklyScreenTime() {
     ...
     */
    static async getMonthlyScreenTime() {
        const now = new Date();
...
//# sourceMappingURL=ScreenTimeApi.js.map